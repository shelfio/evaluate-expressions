...
> **Archived:** This project is no longer maintained. Existing releases remain available as [`@shelf/evaluate-expressions`](https://www.npmjs.com/package/@shelf/evaluate-expressions) on npm.
